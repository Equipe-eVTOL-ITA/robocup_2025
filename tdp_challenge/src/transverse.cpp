#include "transverse/initial_takeoff_state.hpp"
#include "transverse/landing_state.hpp"
#include "transverse/return_home_state.hpp"
#include "transverse/precision_align_state.hpp"
#include "transverse/goto_position_state.hpp"
#include "transverse/ArenaPoint.hpp"
...
class Transverse : public fsm::FSM {
public:
    Transverse() : fsm::FSM({"ERROR", "FINISHED"}) {
        ...
        this->add_transitions("PRECISION ALIGN", {
                                                    {"ALIGNED TO BUCKET", "GO TO POSITION"},
...
public:
    NodeFSM() : rclcpp::Node("transverse_node"), my_fsm() {
